-- CreateEnum
CREATE TYPE "LeaveType" AS ENUM ('ANNUAL', 'DAILY', 'PAID', 'UNPAID');
...
CREATE TABLE "Shop" (
    ...
    "enabledModules" TEXT[] DEFAULT ARRAY['SERVICE', 'STOCK', 'SALE', 'FINANCE', 'EFATURA']::TEXT[],
    ...
    "isCourierEnabled" BOOLEAN NOT NULL DEFAULT true,
    "isEInvoiceEnabled" BOOLEAN NOT NULL DEFAULT true,
    "isFinanceEnabled" BOOLEAN NOT NULL DEFAULT true,
    "isServiceEnabled" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "User" (
    ...
    "serviceCommissionAmount" DECIMAL(12,2) DEFAULT 0,
...
CREATE TABLE "Product" (
    ...
    "shopId" TEXT NOT NULL,
    "attributes" JSONB,
    "hideFromShortage" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "ReceiptSettings" (
    ...
    "shopId" TEXT NOT NULL,
    "logoUrl" TEXT,
    "paperSize" TEXT NOT NULL DEFAULT '72mm',
    "footer2" TEXT DEFAULT 'Yine Bekleriz',
...
CREATE TABLE "EDMSettings" (
    ...
    "senderName" TEXT,
    "senderAddress" TEXT,
    "senderCity" TEXT DEFAULT 'İstanbul',
    "senderDistrict" TEXT,
    "senderTaxOffice" TEXT,
    "username" TEXT,
    "passwordEncrypted" TEXT,
    "apiUrl" TEXT,
    "registrationUrl" TEXT,
    "edmActive" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "TenantSettings" (
    ...
    "edm_username" TEXT NOT NULL,
    "edm_password_encrypted" TEXT NOT NULL,
    "integration_code" TEXT,
    "integration_company_id" INTEGER,
...
CREATE TABLE "StaffExpense" (
    ...
    CONSTRAINT "StaffExpense_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "PerformanceMilestone" (
    "id" TEXT NOT NULL,
    "role" "Role" NOT NULL,
    ...
    CONSTRAINT "PerformanceMilestone_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "MonthlyStaffArchive" (
    "id" TEXT NOT NULL,
    "userId" TEXT,
    "staffName" TEXT,
    "staffEmail" TEXT,
    ...
    CONSTRAINT "MonthlyStaffArchive_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ServiceTicket_shopId_status_idx" ON "ServiceTicket"("shopId", "status");

-- CreateIndex
CREATE INDEX "ServiceTicket_shopId_createdAt_idx" ON "ServiceTicket"("shopId", "createdAt");

-- CreateIndex
CREATE INDEX "ServiceTicket_shopId_warrantyExpiry_idx" ON "ServiceTicket"("shopId", "warrantyExpiry");
...
-- CreateIndex
CREATE UNIQUE INDEX "WhatsAppTemplate_shopId_name_key" ON "WhatsAppTemplate"("shopId", "name");
...
-- CreateIndex
CREATE INDEX "Invoices_tenant_id_direction_idx" ON "Invoices"("tenant_id", "direction");

-- CreateIndex
CREATE INDEX "Invoices_tenant_id_ettn_idx" ON "Invoices"("tenant_id", "ettn");
...
-- CreateIndex
CREATE INDEX "StaffCommission_userId_status_idx" ON "StaffCommission"("userId", "status");

-- CreateIndex
CREATE INDEX "StaffCommission_shopId_createdAt_idx" ON "StaffCommission"("shopId", "createdAt");

-- CreateIndex
CREATE INDEX "StaffExpense_userId_createdAt_idx" ON "StaffExpense"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "PerformanceMilestone_shopId_role_idx" ON "PerformanceMilestone"("shopId", "role");

-- CreateIndex
CREATE INDEX "MonthlyStaffArchive_shopId_period_idx" ON "MonthlyStaffArchive"("shopId", "period");

-- CreateIndex
CREATE UNIQUE INDEX "MonthlyStaffArchive_userId_period_key" ON "MonthlyStaffArchive"("userId", "period");
...
-- AddForeignKey
ALTER TABLE "ServiceTicket" ADD CONSTRAINT "ServiceTicket_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReturnTicket" ADD CONSTRAINT "ReturnTicket_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DailySession" ADD CONSTRAINT "DailySession_openedById_fkey" FOREIGN KEY ("openedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WhatsAppTemplate" ADD CONSTRAINT "WhatsAppTemplate_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StaffCommission" ADD CONSTRAINT "StaffCommission_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffCommission" ADD CONSTRAINT "StaffCommission_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffCommission" ADD CONSTRAINT "StaffCommission_approvedById_fkey" FOREIGN KEY ("approvedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffExpense" ADD CONSTRAINT "StaffExpense_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffExpense" ADD CONSTRAINT "StaffExpense_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PerformanceMilestone" ADD CONSTRAINT "PerformanceMilestone_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MonthlyStaffArchive" ADD CONSTRAINT "MonthlyStaffArchive_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MonthlyStaffArchive" ADD CONSTRAINT "MonthlyStaffArchive_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeaveRequest" ADD CONSTRAINT "LeaveRequest_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;
