            ...
            >
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardHeader className="p-10 pb-6 space-y-4 text-center">
                            ...
                            <div className="space-y-2">
                                <CardTitle className="text-3xl font-black text-white tracking-tight">Dükkanınızı Kurun</CardTitle>
                        ...
                        <CardContent className="px-10 space-y-6">
                            <div className="space-y-2.5">
                                <Label htmlFor="name" className="text-[11px] font-black text-slate-500 uppercase tracking-widest pl-1">DÜKKAN ADI</Label>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2.5">
                                    <Label htmlFor="phone" className="text-[11px] font-black text-slate-500 uppercase tracking-widest pl-1">İLETİŞİM HATTI</Label>
                                    <div className="relative group">
                                ...
                                <div className="space-y-2.5">
                                    <Label htmlFor="balance" className="text-[11px] font-black text-slate-500 uppercase tracking-widest pl-1">AÇILIŞ KASASI (₺)</Label>
                                    <div className="relative group">
                            ...
                            <div className="space-y-2.5">
                                <Label htmlFor="address" className="text-[11px] font-black text-slate-500 uppercase tracking-widest pl-1">ADRES BİLGİSİ</Label>
                                <div className="relative group">
                        ...
                        <CardFooter className="p-10 pt-4 flex flex-col gap-4">
                            <Button
                                type="submit"
                                className="w-full bg-white text-black hover:bg-slate-100 font-black py-7 rounded-2xl transition-all active:scale-95 shadow-xl flex items-center justify-center gap-3 text-base"
                                disabled={loading}
                            >
                                {loading ? (
                                    "Kurulum Başlatıldı..."
                ...
                <div className="mt-8 flex items-center justify-center gap-6 opacity-30">
                    <div className="flex items-center gap-2 group cursor-default">
                        ...
                        <span className="text-[10px] font-black text-white uppercase tracking-widest">AI INTEGRATED</span>
                    </div>
                </div>
            </motion.div>
        </div>
