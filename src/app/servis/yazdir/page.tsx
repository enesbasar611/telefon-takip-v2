    ...
    <div className="bg-white text-black p-4 w-[80mm] mx-auto min-h-screen font-sans text-[10px] leading-tight flex flex-col">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-1.5 px-1">
            ...
            {ticket.cosmeticCondition && (
                <div className="mt-2">
                    <p className="text-[8px] font-bold text-gray-500  mb-0.5">KOZMETİK DURUM:</p>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center border-t-2 border-black pt-3">
            ...
            <span className="text-xl font-black ">₺{Number(ticket.estimatedCost || 0).toLocaleString('tr-TR')}</span>
        </div>
