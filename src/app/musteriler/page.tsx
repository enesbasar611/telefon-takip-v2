         ...
         <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div className="flex items-center gap-6">
               ...
               <div>
                  ...
                  <p className="text-[10px] text-gray-500 font-bold mt-1">STRATEJİK CRM & SADAKAT YÖNETİMİ • {customers.length} KAYIT</p>
               </div>
            </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-3 relative group">
               ...
               <Input
                  ...
                  className="bg-white/[0.02] border-white/5 h-16 pl-12 rounded-[1.5rem] text-sm font-bold placeholder:text-gray-700 focus:ring-1 focus:ring-blue-500/20 focus:bg-white/[0.04] shadow-none transition-all"
               />
            </div>
            <div className="flex items-center gap-3">
               <Button variant="ghost" className="h-16 flex-1 bg-white/[0.02] whisper-border border-white/5 rounded-[1.5rem] font-bold text-[10px] text-gray-500 hover:text-white hover:bg-white/5 transition-all">VIP ÜYELER</Button>
               <Button variant="ghost" className="h-16 flex-1 bg-white/[0.02] whisper-border border-white/5 rounded-[1.5rem] font-bold text-[10px] text-gray-500 hover:text-white hover:bg-white/5 transition-all">KURUMSAL</Button>
            </div>
         </div>
            ...
            <Table>
               <TableHeader className="bg-white/[0.01]">
                  <TableRow className="border-b border-white/[0.03] hover:bg-transparent transition-none">
                     <TableHead className="px-8 py-6 text-[10px] font-bold text-gray-500">Profil Bilgisi</TableHead>
                     <TableHead className="py-6 text-[10px] font-bold text-gray-500">Sadakat Seviyesi</TableHead>
                     <TableHead className="py-6 text-[10px] font-bold text-gray-500">İletişim & CRM</TableHead>
                     <TableHead className="py-6 text-[10px] font-bold text-gray-500 text-center">İşlem Hacmi</TableHead>
                     <TableHead className="px-8 py-6 text-[10px] font-bold text-gray-500 text-right">Aksiyon</TableHead>
                  </TableRow>
               </TableHeader>
               <TableBody>
                        ...
                        <TableRow key={customer.id} className="border-b border-white/[0.03] group hover:bg-white/[0.01] transition-colors">
                           <TableCell className="px-8 py-6">
                              <div className="flex items-center gap-5">
                                 ...
                                 <div>
                                    <div className="flex items-center gap-3">
                                       <span className="font-bold text-sm text-white group-hover:text-blue-400 transition-colors">{customer.name}</span>
                                       {customer.isVip && (
                                          <Badge className="bg-blue-500/10 text-blue-500 border-none font-bold text-[8px] px-2 py-1 rounded-lg animate-pulse">VIP</Badge>
                                       )}
                                    </div>
                           ...
                           <TableCell>
                              <Badge variant="outline" className={`${tier.color} border-none font-bold text-[9px] px-4 py-2 rounded-xl flex items-center gap-2 w-fit transition-all group-hover:scale-105`}>
                           ...
                           <TableCell>
                              <div className="flex flex-col gap-1">
                                 <div className="flex items-center gap-2 text-xs font-bold text-blue-500">
                                    ...
                                    {customer.phone || "TELEFON BELİRTİLMEDİ"}
                                 </div>
                                 <div className="text-[9px] text-gray-600 font-bold truncate max-w-[150px]">
                           ...
                           <TableCell className="text-center">
                              <div className="flex items-center justify-center gap-6">
                                 <div className="flex flex-col items-center">
                                    <span className="text-white text-base font-bold">{customer.tickets?.length || 0}</span>
                                    <span className="text-[8px] font-bold text-gray-600 mt-1">Servis</span>
                                 </div>
                                 <div className="flex flex-col items-center border-l border-white/5 pl-6">
                                    <span className="text-white text-base font-bold shadow-emerald-500/10">{customer.sales?.length || 0}</span>
                                    <span className="text-[8px] font-bold text-gray-600 mt-1">Satış</span>
                                 </div>
                              </div>
                           </TableCell>
                              ...
                              <div className="flex items-center justify-end gap-2">
                                 ...
                                 <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" className="bg-card border-white/5 text-white p-2 min-w-[200px] shadow-none">
                                       <DropdownMenuLabel className="text-[10px] font-bold text-gray-500 p-3 text-center">Profil Yönetimi</DropdownMenuLabel>
                                       <DropdownMenuSeparator className="bg-white/5" />
                                       <Link href={`/musteriler/duzenle/${customer.id}`}>
                                          <DropdownMenuItem className="p-3 text-[10px] font-bold rounded-lg cursor-pointer focus:bg-white/5 flex gap-3 items-center">
                                             <UserCircle className="h-4 w-4 text-blue-500" /> Profili Düzenle
                                          </DropdownMenuItem>
                                       </Link>
                                       <DropdownMenuItem className="p-3 text-[10px] font-bold rounded-lg cursor-pointer focus:bg-white/5 flex gap-3 items-center group">
                                       ...
                                       <DropdownMenuSeparator className="bg-white/5" />
                                       <DropdownMenuItem className="p-3 text-[10px] font-bold rounded-lg cursor-pointer text-rose-500 focus:bg-rose-500/10 focus:text-rose-500 flex gap-3 items-center">
                                          Kalıcı Olarak Sil
                                       </DropdownMenuItem>
                                    </DropdownMenuContent>
                                 </DropdownMenu>
