...
const getLoyaltyTier = (points: number) => {
    if (points >= 1000) return { label: "PLATİN", color: "text-blue-400 bg-blue-400/10 border-blue-400/20 shadow-blue-sm", icon: Gem, next: 0, percent: 100 };
    ...
    <div className="p-8 space-y-8 bg-[#0a0a0b] text-white min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start justify-between mb-10">
        <div className="flex gap-8 items-center">
          ...
          <div className="h-28 w-28 rounded-[2rem] bg-blue-500/10 border-4 border-[#141416] flex items-center justify-center relative shadow-2xl overflow-hidden group hover:scale-105 transition-all">
            {customer.photo ? (
            ...
            {customer.isVip && (
              <div className="absolute top-0 right-0 h-6 w-6 bg-blue-500 flex items-center justify-center rounded-bl-xl border-4 border-[#141416] shadow-blue-sm">
          ...
          <div>
            <div className="flex items-center gap-4 mb-2">
              ...
              {customer.isVip && (
                <Badge className="bg-blue-500/10 text-blue-500 border-none font-black text-[10px] tracking-widest px-4 py-1.5 rounded-xl shadow-blue-sm animate-pulse">VIP ÜYE</Badge>
              )}
            </div>
        ...
        <div className="flex gap-3">
           <Link href={`/musteriler/duzenle/${customer.id}`}>
             <Button className="bg-white/[0.03] whisper-border border-white/5 text-gray-400 hover:text-blue-500 hover:bg-blue-500/5 px-6 h-12 rounded-2xl font-black uppercase tracking-widest transition-all shadow-xl">PROFİLİ DÜZENLE</Button>
           </Link>
           <Button className="bg-blue-500 text-black px-6 h-12 rounded-2xl font-black uppercase tracking-widest shadow-blue-strong hover:bg-blue-400 transition-all">SATIŞ YAP</Button>
        </div>
      </div>
        ...
        <Card className="lg:col-span-1 bg-[#141416] border-white/5 shadow-2xl group overflow-hidden relative">
            ...
            <CardHeader className="border-b border-white/[0.03] pb-6 bg-white/[0.01]">
                <div className="flex items-center gap-3">
                    <TrendingUp className="h-4 w-4 text-blue-500 shadow-blue-sm" />
            ...
            <CardContent className="p-8 space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <Progress value={tier.percent} className="h-2 bg-white/[0.03] [&>div]:bg-blue-500 shadow-blue-sm" />
                    {tier.next > 0 && (
            ...
            <div className="col-span-1 md:col-span-3">
                <Tabs defaultValue="history" className="w-full">
                    <TabsList className="bg-transparent border-b border-white/5 w-full justify-start rounded-none h-auto p-0 gap-10 mb-8">
                        <TabsTrigger value="history" className="rounded-none border-b-2 border-transparent data-[state=active]:border-blue-500 data-[state=active]:bg-transparent data-[state=active]:text-blue-400 px-0 py-4 font-black uppercase text-[10px] tracking-[0.2em] transition-all">İŞLEM ARŞİVİ</TabsTrigger>
                        <TabsTrigger value="warranty" className="rounded-none border-b-2 border-transparent data-[state=active]:border-blue-500 data-[state=active]:bg-transparent data-[state=active]:text-blue-400 px-0 py-4 font-black uppercase text-[10px] tracking-[0.2em] transition-all">AKTİF GARANTİLER</TabsTrigger>
                        <TabsTrigger value="notes" className="rounded-none border-b-2 border-transparent data-[state=active]:border-blue-500 data-[state=active]:bg-transparent data-[state=active]:text-blue-400 px-0 py-4 font-black uppercase text-[10px] tracking-[0.2em] transition-all">MÜŞTERİ NOTLARI</TabsTrigger>
                    </TabsList>
                                ...
                                <div key={idx} className="bg-[#141416] p-6 rounded-3xl whisper-border border-white/5 flex items-center justify-between hover:bg-white/[0.02] transition-all group shadow-2xl">
                                    ...
                                    <div className="flex items-center gap-12">
                                        ...
                                        <div className="text-right min-w-[120px]">
                                            ...
                                            <span className="text-xl font-black text-white shadow-blue-sm">₺{(Number(item.actualCost) || Number(item.finalAmount) || 0).toLocaleString('tr-TR')}</span>
                                        </div>
                                    </div>
                                </div>
                            ))
                                    ...
                                    <Card key={ticket.id} className="bg-[#141416] border-white/5 shadow-2xl overflow-hidden group">
                                        <CardHeader className="pb-4 border-b border-white/[0.03] bg-white/[0.01]">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    <div className="h-10 w-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-500 shadow-blue-sm">
                                        ...
                                        <CardContent className="pt-8">
                                            ...
                                            <div className="flex items-center justify-between mt-5">
                                                ...
                                                <Button variant="ghost" className="text-[8px] font-black uppercase text-blue-500 hover:bg-blue-500/5 px-0 h-auto">
