                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="rounded-xl border border-violet-500/20 bg-violet-500/5 p-4 space-y-3">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-[12px] font-black text-violet-300">AI ile Kategori + Ürün</p>
                        </div>
                        ...
                        <div className="bg-black/30 rounded-lg px-3 py-2 text-[10px] text-slate-400 font-mono leading-relaxed border border-white/5">
                            &quot;Şarj Aletleri &gt; Type-C &gt; 27W şarj aleti, 10 adet, alış 100 satış 500 TL, raf B-3&quot;
                        </div>
                        <p className="text-[10px] text-slate-500">→ Gemini hiyerarşiyi ve ürünleri otomatik oluşturur</p>
                    </div>
                    ...
                    <div className="rounded-xl border border-blue-500/20 bg-blue-500/5 p-4 space-y-3">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-[12px] font-black text-blue-300">Toplu AI Stok Ekle</p>
                        </div>
                        <p className="text-[11px] text-slate-400 leading-relaxed">
                    ...
                    <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/5 p-4 space-y-3">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-[12px] font-black text-indigo-300">Manuel Tek Ürün</p>
                        </div>
                        <p className="text-[11px] text-slate-400 leading-relaxed">
