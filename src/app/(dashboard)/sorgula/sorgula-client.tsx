                        ...
                        <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                <Button
                                    type="submit"
                                    disabled={isPending}
                                    className="w-full h-16 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white  transition-all text-sm"
                                >
                        ...
                        <Card className="matte-card border-border/10/50 rounded-2xl overflow-hidden">
                            <div className="bg-blue-600/10 p-10 border-b border-border/10/50">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                    <div>
                                        <Badge className={`${statusConfig[ticket.status].color} border-none text-[10px]  px-4 py-1.5 mb-4`}>
                            ...
                            <CardContent className="p-10 space-y-10">
                                ...
                                <div>
                                    <div className="flex items-center gap-3 mb-6">
                                        <div className="h-2 w-2 rounded-full bg-blue-500" />
                                        <h3 className="font-medium text-xs  text-white">SERVİS GEÇMİŞİ</h3>
                                    </div>
