    ...
    <div className="flex flex-col gap-10 pb-20 bg-background text-foreground min-h-screen lg:p-14 p-8 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="text-5xl font-extrabold text-foreground tracking-tight font-sans">Finans Yönetimi</h1>
            <p className="text-sm text-slate-500 font-bold mt-1 uppercase tracking-widest">NAKİT AKIŞI VE HESAP TAKİBİ</p>
          </div>
        </div>

        <Suspense fallback={<Skeleton className="h-14 w-48 rounded-2xl" />}>
          <DailySessionStream />
        </Suspense>
      </div>
