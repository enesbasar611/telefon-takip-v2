    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-500/80">Finans Merkezi</span>
          </div>
      ...
      <Card className="bg-white/[0.02] border-white/5 whisper-border shadow-2xl overflow-hidden">
              ...
              {transactions.length === 0 ? (
                ...
                transactions.map((t: any) => (
                  <TableRow key={t.id} className="border-white/5 hover:bg-white/[0.02] transition-colors group">
                    ...
                    <TableCell>
                      <Badge variant="outline" className="bg-white/[0.03] border-white/5 text-[9px] font-black text-gray-400 py-0.5 px-3 rounded-xl uppercase tracking-widest group-hover:text-blue-400 group-hover:border-blue-500/20 transition-all">
        ...
        <div className="p-4 border-t border-white/5 bg-white/[0.01] flex items-center justify-between">
           ...
           <Button variant="ghost" size="sm" className="h-8 text-[10px] font-black uppercase text-blue-500 bg-blue-500/5 border border-blue-500/20 rounded-lg px-6 hover:bg-blue-500/10 shadow-blue-sm">TÜM ARŞİVİ GÖR</Button>
        </div>
      </Card>
    </div>
  );
