/**
 * Turkiye Il ve Ilce veri listesi
 * GIB ve EDM standartlarina uygun resmi isimler
 * Kaynak: TUIK ve GIB adres standardi
 */
...
export const TURKEY_CITIES: City[] = [
    ...
    },
    {
        name: "Antalya",
        plateCode: "07",
        districts: ["Akseki", "Alanya", "Demre", "Döşemealtı", "Elmalı", "Finike", "Gazipaşa", "Gündoğmuş", "İbradı", "Kaş", "Kemer", "Kepez", "Konyaaltı", "Korkuteli", "Kumluca", "Manavgat", "Muratpaşa", "Serik"],
    },
    {
        name: "Ardahan",
        plateCode: "75",
    ...
    },
    {
        name: "Çanakkale",
        plateCode: "17",
        districts: ["Ayvacık", "Bayramiç", "Biga", "Çan", "Eceabat", "Ezine", "Gelibolu", "Gökçeada", "Lapseki", "Merkez", "Yenice"],
    },
    {
        name: "Çankırı",
        plateCode: "18",
    ...
    },
    {
        name: "Isparta",
        plateCode: "32",
        districts: ["Aksu", "Atabey", "Eğirdir", "Gelendost", "Gönen", "Keçiborlu", "Merkez", "Şarkikaraağaç", "Senirkent", "Sütçüler", "Uluborlu", "Yalvaç", "Yenişarbademli"],
    },
    {
        name: "İstanbul",
        plateCode: "34",
    ...
    },
    {
        name: "Yozgat",
        plateCode: "66",
        districts: ["Akdağmadeni", "Aydıncık", "Boğazlıyan", "Çandır", "Çayıralan", "Çekerek", "Kadışehri", "Merkez", "Saraykent", "Sarıkaya", "Şefaatli", "Yenifakılı", "Yerköy"],
    },
    {
        name: "Zonguldak",
        plateCode: "67",
...
/**
 * Il ismine gore ilce listesini dondurur
 */
...
/**
 * Plaka koduna gore il ismini dondurur
 */
export function getCityByPlateCode(plateCode: string): City | undefined {
    return TURKEY_CITIES.find((c) => c.plateCode === plateCode);
}

/**
 * Il isminin gecerli olup olmadigini kontrol eder
 */
export function isValidCity(cityName: string): boolean {
    return TURKEY_CITIES.some((c) => c.name === cityName);
}

/**
 * Ilce isminin belirli bir il icinde gecerli olup olmadigini kontrol eder
 */
export function isValidDistrict(cityName: string, districtName: string): boolean {
