    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <div className="bg-[#121629] p-5 rounded-2xl flex flex-col gap-3 border border-border/60 shadow-lg cursor-pointer hover:border-purple-500/30 transition-all group overflow-hidden relative">
