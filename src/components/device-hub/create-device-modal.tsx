  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="gap-2 h-12 px-8 bg-blue-600 text-white font-black uppercase tracking-widest rounded-2xl hover:bg-blue-500 shadow-blue-sm transition-all italic">
      ...
      <DialogContent className="sm:max-w-[700px] bg-[#020617] border-slate-800 text-white p-0 overflow-hidden rounded-[2.5rem]">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="p-10 space-y-8">
            <DialogHeader>
              <div className="flex items-center gap-4 mb-2">
                 ...
                 <DialogTitle className="text-2xl font-black uppercase tracking-tighter">Envanter Tanımlama</DialogTitle>
              </div>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Cihaz Durumu</Label>
                  <div className="flex gap-2 p-1.5 bg-slate-900/40 border border-slate-800 rounded-2xl">
                    <Button
                      type="button"
                      variant="ghost"
                      className={`flex-1 h-10 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${condition === "NEW" ? 'bg-blue-600 text-white shadow-blue-sm' : 'text-slate-500'}`}
                    ...
                    <Button
                      type="button"
                      variant="ghost"
                      className={`flex-1 h-10 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${condition === "USED" ? 'bg-blue-600 text-white shadow-blue-sm' : 'text-slate-500'}`}
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Marka</Label>
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500">IMEI Numarası</Label>
              ...
              <div className="space-y-6">
                 <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Renk</Label>
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Kapasite</Label>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Batarya Sağlığı (%)</Label>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500 italic">ALIŞ FİYATI (₺)</Label>
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500 italic text-blue-400">SATIŞ FİYATI (₺)</Label>
          ...
          <div className="p-10 border-t border-slate-800/50 bg-slate-900/20 flex items-center justify-end gap-4">
            <Button type="button" variant="ghost" onClick={() => setOpen(false)} disabled={isPending} className="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-white">Vazgeç</Button>
            <Button type="submit" disabled={isPending} className="bg-blue-600 hover:bg-blue-500 text-white font-black uppercase tracking-widest px-12 h-14 rounded-2xl shadow-blue-sm transition-all italic">
