                ...
                <div className="p-6 max-h-[70vh] overflow-y-auto custom-scrollbar space-y-6">
                    {!analysis ? (
                        ...
                        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                            <div className="flex items-center gap-2 text-violet-400  text-[10px] uppercase tracking-wider mb-2">
                    ...
                    {!analysis && (
                        <Button
                            ...
                            disabled={isPending}
                            className="w-full h-12 bg-violet-600 hover:bg-violet-700  text-white transition-all shadow-lg active:scale-[0.98]"
                        >
