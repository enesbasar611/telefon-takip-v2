                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-border/10/50">
                            ...
                            <div className="flex gap-2">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuItem onClick={() => onQuickSell(product)} className="text-[10px] font-bold p-3 gap-3 cursor-pointer focus:bg-white/5">
                                        <ShoppingCart className="h-4 w-4 text-emerald-500" /> HIZLI SATIŞ
                                    </DropdownMenuItem>
                                    <DropdownMenuSeparator className="bg-white/5" />
                                        <DropdownMenuItem className="text-[10px] font-bold p-3 gap-3"><Edit className="h-4 w-4 text-blue-500" /> DÜZENLE</DropdownMenuItem>
                                        <DropdownMenuItem className="text-[10px] font-bold p-3 gap-3 text-rose-500"><Trash2 className="h-4 w-4" /> SİL</DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            </div>
                        </div>
          ...
          <Table className="hidden lg:table">
            <TableHeader className="bg-slate-900/40">
              <TableRow className="border-border/10/50 hover:bg-transparent">
                ...
                <TableHead className="text-[10px] font-bold text-slate-500 py-4">KATEGORİ</TableHead>
              ...
              {filteredProducts.length === 0 ? (
                ...
                filteredProducts.map((product: any) => (
                  <TableRow key={product.id} className="border-border/10/50 hover:bg-slate-900/30 transition-colors group">
                    ...
                    <TableCell>
                      <Badge variant="outline" className="bg-slate-900 border-border/10 text-[9px] font-bold text-slate-500 py-1 px-3 rounded-xl">
                        {product.category.name}
                      </Badge>
                    </TableCell>
                    <TableCell>
