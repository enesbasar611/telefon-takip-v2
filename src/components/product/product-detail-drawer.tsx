                    ...
                    <div className="flex-1 overflow-hidden px-6 pb-6">
                        <Tabs defaultValue="info" className="h-full flex flex-col">
                            <TabsList className="grid w-full grid-cols-2 bg-slate-900 border border-white/5 p-1 rounded-xl mb-6">
                                <TabsTrigger value="info" className="text-[11px] font-bold gap-2 rounded-lg data-[state=active]:bg-slate-800 data-[state=active]:text-white">
                                    <Info className="h-3.5 w-3.5" /> BİLGİLER
                                </TabsTrigger>
                                <TabsTrigger value="history" className="text-[11px] font-bold gap-2 rounded-lg data-[state=active]:bg-slate-800 data-[state=active]:text-white">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between p-3 rounded-xl bg-slate-900/20 border border-white/5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[11px] font-bold text-slate-400">BARKOD / SKU</span>
                                            </div>
                                            <span className="text-[11px] font-bold text-white uppercase">{product.barcode || product.sku || "-"}</span>
                                        </div>
                                        <div className="flex items-center justify-between p-3 rounded-xl bg-slate-900/20 border border-white/5">
                                            <div className="flex items-center gap-3">
                                                <MapPin className="h-4 w-4 text-blue-400" />
                                                <span className="text-[11px] font-bold text-slate-400">RAF / KONUM</span>
                                            </div>
                                            <Badge variant="outline" className="text-[10px] font-bold border-blue-500/20 bg-blue-500/5 text-blue-400 uppercase">
                                        ...
                                        <div className="flex items-center justify-between p-3 rounded-xl bg-slate-900/20 border border-white/5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[11px] font-bold text-slate-400">TEDARİKÇİ</span>
                                            </div>
                                            <span className="text-[11px] font-bold text-white uppercase">S. GÖKSU</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-2xl bg-slate-900 border border-white/5 space-y-3">
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Birim Maliyet</span>
                                            <RevealFinancial amount={product.buyPrice} className="text-sm font-bold text-white" />
                                        </div>
                                        <div className="h-px bg-white/5" />
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Toplam Envanter Değeri</span>
                                            <RevealFinancial amount={product.buyPrice * product.stock} className="text-sm font-bold text-white" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-500/10 space-y-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[11px] font-bold text-blue-400 uppercase tracking-widest">Hızlı Stok Ekle</span>
                                        </div>
                                        <div className="flex gap-2">
                                            <Input
                                                ...
                                                className="bg-slate-950 border-white/5 h-10 text-xs font-bold rounded-xl focus-visible:ring-blue-500"
                                            />
                                            <Button
                                                onClick={handleAddStock}
                                                disabled={isUpdating}
                                                className="bg-blue-600 hover:bg-blue-500 text-white font-bold text-[10px] h-10 px-4 rounded-xl flex-shrink-0"
                                            >
                            ...
                            <TabsContent value="history" className="flex-1 m-0 overflow-hidden">
                                <ScrollArea className="h-full pr-4">
                                    {loading ? (
                                        <p className="text-center text-[10px] font-bold text-slate-500 py-10">Hareketler yükleniyor...</p>
                                    ) : movements.length === 0 ? (
                                        <div className="flex flex-col items-center justify-center py-20 text-slate-600">
                                            <AlertCircle className="h-10 w-10 mb-2 opacity-20" />
                                            <p className="text-[10px] font-bold">Herhangi bir hareket bulunamadı.</p>
                                        </div>
                                    ) : (
