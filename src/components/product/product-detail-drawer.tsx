...
export function ProductDetailDrawer({
    ...
    return (
        <Sheet open={isOpen} onOpenChange={onClose}>
            <SheetContent className="w-full sm:max-w-md bg-background border-l border-border/50 p-0 sm:p-0">
                        ...
                        <Tabs defaultValue="info" className="h-full flex flex-col">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center justify-between p-3 rounded-xl bg-card/20 border border-border/50">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[11px]  text-muted-foreground">RAF / KONUM</span>
                                            </div>
                                    ...
                                    <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-500/10 space-y-4">
                                        ...
                                        <div className="flex gap-2">
                                            <Input
                                                ...
                                                className="bg-background border-border/50 h-10 text-xs  rounded-xl focus-visible:ring-blue-500"
                                            />
                                            <Button
                            ...
                            <TabsContent value="history" className="flex-1 m-0 overflow-hidden">
                                <ScrollArea className="h-full pr-4">
                                    {loading ? (
                                        <p className="text-center text-[10px]  text-muted-foreground/80 py-10">Hareketler yükleniyor...</p>
                                    ) : movements.length === 0 ? (
