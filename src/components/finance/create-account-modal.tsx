                ...
                <form onSubmit={handleSubmit} className="p-10">
                    <DialogHeader className="mb-10 p-0 text-left">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <DialogTitle className="text-2xl font-black tracking-tight">{isEdit ? "Hesabı Düzenle" : "Yeni Hesap Tanımla"}</DialogTitle>
                    ...
                    <div className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <Input id="name" name="name" required defaultValue={account?.name} placeholder="Örn: Ziraat Bankası, Shop Kasa" className="h-14 rounded-[1.5rem] text-xs font-black bg-muted/20 border-border/40 px-6 shadow-inner focus:ring-2 focus:ring-blue-500/20 transition-all" />
                        </div>
                        ...
                        <div className="space-y-4">
                            <Label htmlFor="initialBalance" className="text-[11px] font-black text-muted-foreground ml-1 uppercase tracking-[0.2em]">
                                {isEdit ? "GÜNCEL BAKİYE (TL)" : "AÇILIŞ BAKİYESİ (TL)"}
                            </Label>
                            <Input id="initialBalance" name="initialBalance" type="number" step="0.01" defaultValue={account?.balance || "0"} className="h-14 rounded-[1.5rem] text-lg font-black bg-muted/20 border-border/40 px-6 shadow-inner focus:ring-2 focus:ring-blue-500/20 transition-all" />
                        </div>
                    </div>
                    ...
                    <div className="mt-10 flex gap-4">
                        ...
                        <Button type="submit" disabled={loading} className={cn("flex-[2] h-14 text-xs font-black rounded-[1.5rem] shadow-xl text-white uppercase tracking-[0.2em]", isEdit ? "bg-orange-600 hover:bg-orange-700 shadow-orange-500/20" : "bg-blue-600 hover:bg-blue-700 shadow-blue-500/20")}>
