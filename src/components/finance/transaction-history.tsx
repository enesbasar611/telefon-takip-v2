                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pl-10 h-10 w-64 rounded-xl text-xs  border-border/40 bg-muted/20"
                        />
                    </div>
                    <div className="flex items-center gap-1 p-1 bg-muted/40 border border-border/40 rounded-xl">
                        {["ALL", "CASH", "CARD", "TRANSFER"].map((method) => (
                            <Button
                                ...
                                className={cn(
                                    "h-8 text-[10px]  rounded-lg px-4 transition-all uppercase tracking-tight",
                ...
                <div className="overflow-x-auto">
                    <Table>
                        ...
                        <TableBody>
                            {sortedData.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={5} className="h-48 text-center text-xs  text-muted-foreground uppercase tracking-widest opacity-40">
