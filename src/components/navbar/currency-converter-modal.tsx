    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-card border-border rounded-xl p-10 max-w-2xl shadow-2xl">
        <DialogHeader className="flex flex-row items-center justify-between mb-8">
          <div>
            <DialogTitle className="font-medium text-2xl font-extrabold">Döviz ve altın çevirici</DialogTitle>
          ...
          <Button
            ...
            className="rounded-xl border-border bg-muted hover:bg-blue-500/10 hover:text-blue-500 transition-all flex gap-2 h-10 px-6 "
          >
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-medium text-lg font-extrabold">Amerikan doları</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="font-medium text-xs  text-muted-foreground">Dolar miktarı</Label>
                <Input
                  type="number"
                  placeholder="0.00"
                  value={usd}
                  onChange={(e) => onUsdChange(e.target.value)}
                  className="rounded-xl border-border focus:ring-blue-500 focus:border-blue-500 h-12 text-base "
                />
              </div>
              <div className="space-y-2">
                <Label className="font-medium text-xs  text-muted-foreground">Türk lirası karşılığı</Label>
                <Input
                  type="number"
                  placeholder="0.00"
                  value={usdTl}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-medium text-lg font-extrabold">Avrupa para birimi</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="font-medium text-xs  text-muted-foreground">Euro miktarı</Label>
                <Input
                  type="number"
                  placeholder="0.00"
                  value={eur}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-medium text-lg font-extrabold">Gram altın</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="font-medium text-xs  text-muted-foreground">Altın miktarı (gr)</Label>
                <Input
                  type="number"
                  placeholder="0.00"
                  value={gold}
