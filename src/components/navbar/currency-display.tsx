    ...
    <div className="flex items-center gap-2">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="sm" className="h-10 px-4 bg-slate-900/40 border border-slate-800/50 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-blue-500 hover:border-blue-500/20 transition-all flex gap-3 shadow-2xl group">
        ...
        <DropdownMenuContent align="end" className="bg-[#141416] border-white/5 text-white p-2 min-w-[180px] shadow-2xl">
          <div className="p-3">
             <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-1">Döviz Kurları</p>
             <p className="text-[9px] font-bold text-gray-600 uppercase">Son Güncelleme: Otomatik</p>
          </div>
