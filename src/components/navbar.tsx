...
export function Navbar() {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-slate-800/50 bg-[#020617]/80 backdrop-blur-xl px-4 lg:px-8 sticky top-0 z-10 shadow-none">
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2 pr-6 border-r border-slate-800/50">
            <CreateServiceModal
            trigger={
                <Button variant="ghost" size="sm" className="hidden md:flex gap-2 text-xs font-semibold text-slate-200 bg-slate-900/40 border border-slate-800/50 rounded-xl px-4 hover:bg-blue-600/10 hover:text-blue-400 hover:border-blue-500/20 shadow-none transition-all group">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="ghost" size="icon" className="relative h-10 w-10 rounded-xl bg-slate-900/40 border border-slate-800/50 text-slate-500 hover:text-blue-500 hover:bg-blue-600/5 transition-all">
            ...
            <span className="absolute top-2.5 right-2.5 h-2 w-2 rounded-full bg-blue-500 animate-pulse " />
          </Button>

          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="rounded-xl h-10 w-10 bg-slate-900/40 border border-slate-800/50 hover:border-blue-500/20 shadow-none overflow-hidden group">
            ...
            <DropdownMenuContent align="end" className="bg-[#141416] border-white/5 text-white p-2 min-w-[200px] shadow-none">
              <DropdownMenuLabel className="text-[10px]   font-black text-gray-500 p-3">KULLANICI HESABI</DropdownMenuLabel>
