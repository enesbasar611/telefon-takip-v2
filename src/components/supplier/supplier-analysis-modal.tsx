        ...
        <div className="flex flex-col gap-2">
            {addedTo.length > 0 && (
                <div className="flex flex-wrap gap-1">
                    {addedTo.map((name) => (
                        <Badge key={name} className="bg-emerald-500/10 text-emerald-400 border-none text-[9px]  px-2 py-0.5 gap-1">
            ...
            {!open ? (
                ...
                <div className="flex items-center gap-2 p-2 rounded-xl bg-white/[0.03] border border-border flex-wrap">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs  text-foreground w-6 text-center">{qty}</span>
                        <Button
                            variant="ghost"
                            size="icon"
                            className="h-7 w-7 rounded-lg bg-white/5 border border-border text-muted-foreground hover:bg-white/10"
                    ...
                    <Button
                        ...
                        onClick={handleAdd}
                        className="h-8 px-3 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white  text-[10px]"
                    >
                ...
                <div className="relative p-8 bg-gradient-to-br from-blue-600/10 to-transparent border-b border-border/50 overflow-hidden shrink-0">
                    ...
                    <div className="relative z-10 flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            <Badge className="bg-blue-600/10 text-blue-500 border-none text-[9px]  uppercase tracking-[0.2em] px-3 mb-2">
                    ...
                    <div className="relative z-10 flex gap-3 mt-5 flex-wrap">
                        <div className="flex items-center gap-2 bg-rose-500/10 border border-rose-500/20 rounded-xl px-4 py-2">
                            ...
                            <span className="text-xs  text-rose-400">{totalUrgent} Acil Ürün</span>
                        </div>
                                ...
                                <div key={p.id} className={cn(
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            <Badge className={cn("text-[8px]  border-none px-2 py-0.5", p.stock <= 0 ? "bg-rose-500/10 text-rose-400" : "bg-amber-500/10 text-amber-400")}>
                            ...
                            {trendingAlerts.map((alert) => {
                                ...
                                return (
                                    <div key={alert.id} className={cn("flex items-start gap-4 p-4 rounded-2xl border", style.bg, style.border)}>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <Badge className={cn("text-[8px]  border-none px-2 py-0.5 mb-1", style.bg, style.color)}>{style.label}</Badge>
