...
export function BottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-xl border-t border-slate-800/50 flex items-center justify-around px-2 z-50">
      {items.map((item) => {
