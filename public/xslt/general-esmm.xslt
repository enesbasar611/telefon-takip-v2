...
"brutucret":"<xsl:value-of select="n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount"/>",
"tahsilkdv":"<xsl:value-of select="n1:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount"/>",
"kdvtevkifat":"<xsl:value-of select="n1:Invoice/cac:WithholdingTaxTotal/cbc:TaxAmount"/>",
"gvstopaj":"<xsl:value-of select="sum(n1:Invoice/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0003']/cbc:TaxAmount)"/>",
<xsl:for-each select="n1:Invoice/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015']"><xsl:text> "kdvtutari</xsl:text>":<xsl:value-of select="cbc:TaxAmount"/>"</xsl:for-each>,
"netucret":"<xsl:value-of select="n1:Invoice/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount"/>",
"tahsilat":"<xsl:value-of select="n1:Invoice/cac:InvoiceLine/cac:Price/cbc:PriceAmount"/>",
							...
							<tr valign="top">
									...
									<table align="center" border="0" width="100%">
										<tbody>
											...
											<xsl:for-each
												...
												<xsl:if	test="cbc:ID/@schemeID = 'VKN' or cbc:ID/@schemeID = 'TCKN'">
												<tr align="left">
												<td>
								...
								<td width="20%" align="center">
									<br/>
									<br/>
									<img style="width:91px;margin-right:20px" alt="E-Fatura Logo"
								...
								<!-- <td width="40%"> -->
								<!-- <div id="qrcode" align="right" style="margin-top:15%;margin-right:5%"/> -->
							...
							<tr style="height:118px; " valign="top">
								...
								<td width="60%" valign="bottom" colspan="2">
									<table style="border:1px solid silver" id="smmTable">
										<tbody style="border:1px solid silver" >
											<tr style="height:20px; ">
												<td align="left" style="background-color:#efefea;border:1px solid silver">
												<span style="font-weight:bold; ">
					...
					<table border="1" id="lineTable" width="800">
						<tbody>
							<tr class="lineTableTr">
								<td class="lineTableTd lineTableTd-Custom" style="width:3%" align="center">
									<span style="font-weight:bold;">
										<xsl:text>Sıra No</xsl:text>
									</span>
								</td>
								<td class="lineTableTd lineTableTd-Custom" style="width:30%;" align="center">
									<span style="font-weight:bold;">
										<xsl:text>Ücretin Ne İçin Alındığı</xsl:text>
									</span>
								</td>
								<td class="lineTableTd lineTableTd-Custom" style="width:7.4%" align="center">
									<span style="font-weight:bold;">
										<xsl:text>Brüt Ücret</xsl:text>
									</span>
								</td>
								<td class="lineTableTd lineTableTd-Custom" style="width:9%;" align="center">
									<span style="font-weight:bold;">
										<xsl:text>G.V. Stopaj Oranı %</xsl:text>
									</span>
								</td>
								<td class="lineTableTd lineTableTd-Custom" style="width:7%" align="center">
									<span style="font-weight:bold;">
								...
								<td class="lineTableTd lineTableTd-Custom" style="width:10.6%" align="center">
									<span style="font-weight:bold;">
				...
				<table id="budgetContainerTable" width="800px" >
					...
					<tr align="right">
						...
						<td class="lineTableBudgetTd lineTableBudgetTd-Custom" width="200px" align="right">
							<span style="font-weight:bold; ">
								<xsl:text>Net Alınan Toplam:</xsl:text>
							</span>
						</td>
						<td class="lineTableBudgetTd" style="width:82px; " align="right">
...
<xsl:if test="//n1:Invoice/cbc:Note">				
	...
	<xsl:template match="//n1:Invoice/cac:InvoiceLine">
		<tr class="lineTableTr">
			<td class="lineTableTd"><!-- SIRANO -->
				<xsl:text>&#160;</xsl:text>
				<xsl:value-of select="./cbc:ID"/>
			</td>
			<td class="lineTableTd"><!-- MALHIZMETADI -->
				<xsl:text>&#160;</xsl:text>
				<xsl:value-of select="./cac:Item/cbc:Name"/>
			</td>
			<td class="lineTableTd" align="right"><!-- BRÜT ÜCRET -->
				<xsl:text>&#160;</xsl:text>
				<xsl:value-of
					select="format-number(./cbc:LineExtensionAmount, '###.###,####', 'european')"/>
			...
			<td class="lineTableTd" align="right"><!-- G.V. Stopaj Oranı -->
				<xsl:text>&#160;</xsl:text>
				<xsl:for-each
			...
			<td class="lineTableTd" align="right"><!-- Net Ücret -->
				<xsl:text>&#160;</xsl:text>
				<xsl:value-of
					select="format-number(./cbc:InvoicedQuantity, '###.##0,########', 'european')"/>
				<xsl:if test="./cbc:InvoicedQuantity/@currencyID">
					<xsl:text> </xsl:text>
					<xsl:if test="./cbc:InvoicedQuantity/@currencyID = &quot;TRL&quot; or ./cac:Price/cbc:InvoicedQuantity/@currencyID = &quot;TRY&quot;">
						<xsl:text>TL</xsl:text>
					</xsl:if>
					<xsl:if test="./cbc:InvoicedQuantity/@currencyID != &quot;TRL&quot; and ./cac:Price/cbc:InvoicedQuantity/@currencyID != &quot;TRY&quot;">
						<xsl:value-of select="./cbc:InvoicedQuantity/@currencyID"/>
					</xsl:if>
				</xsl:if>
			</td>
			<td class="lineTableTd" align="right"><!-- Kdv Oranı -->
				<xsl:text>&#160;</xsl:text>
				<xsl:for-each
					select="./cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme">
			...
			<td class="lineTableTd" style="font-size: xx-small" align="right"><!-- Kdv TEVKIFAT -->
				<xsl:text>&#160;</xsl:text>
			...
			<td class="lineTableTd" align="right"><!-- Kdv TEVKIFAT Oranı -->
				<xsl:text>&#160;</xsl:text>
				<xsl:for-each
					select="./cac:WithholdingTaxTotal/cac:TaxSubtotal">
						<xsl:text> </xsl:text>
						<xsl:if test="./cbc:Percent">
							<xsl:text> %</xsl:text>
							<xsl:value-of
			...
			<td class="lineTableTd" align="right"><!-- NET TAHSİLAT -->
				<xsl:text>&#160;</xsl:text>
				<xsl:value-of
					select="format-number(./cac:Price, '###.###,####', 'european')"/>
					<xsl:if test="./cac:Price/@currencyID">
					<xsl:text> </xsl:text>
					<xsl:if test="./cac:Price/@currencyID = &quot;TRL&quot; or ./cac:Price/@currencyID = &quot;TRY&quot;">
						<xsl:text>TL</xsl:text>
					</xsl:if>
					<xsl:if test="./cac:Price/@currencyID != &quot;TRL&quot; and ./cac:Price/@currencyID != &quot;TRY&quot;">
						<xsl:value-of select="./cac:Price/@currencyID"/>
					</xsl:if>
				</xsl:if>
			</td>
		</tr>
