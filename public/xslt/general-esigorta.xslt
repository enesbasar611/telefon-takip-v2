							...
							<tr valign="top">
								...
								<td align="right">
									...
									<div id="qrvalue"
										...
										> {"tur":"E-Arsiv", "vkntckn":"<xsl:value-of
											select="n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'TCKN' or @schemeID = 'VKN']"
										/>", "unvan":"<xsl:value-of
											select="translate(n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name, 'ĞÜŞÇİÖğüşçıö', 'GUSCIOguscio')"
										...
										/>", "aunvan":"<xsl:value-of
											select="translate(n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name, 'ĞÜŞÇİÖğüşçıö', 'GUSCIOguscio')"
										/>", "senaryo":"<xsl:value-of
											select="n1:CreditNote/cbc:ProfileID"/>",
											"tip":"<xsl:value-of
											select="n1:CreditNote/cbc:CreditNoteTypeCode"/>",
											"belgetarih":"<xsl:value-of
											...
											/>", "istihsalkomisyon":"<xsl:value-of
												select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount"
											/>","iptalkomisyon":"<xsl:value-of
												select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount"
											/>", "toplamkomisyon":"<xsl:value-of
									...
									<table id="customerPartyTable" align="left" border="0">
										<tbody>
											<tr style="height:71px; ">
												...
												<xsl:choose>
												<xsl:when
												test="n1:CreditNote/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'PARTYTYPE' and text() = 'TAXFREE']">
												<xsl:for-each
												select="n1:CreditNote/cac:BuyerCustomerParty/cac:Party">
												...
												<xsl:when
												test="n1:CreditNote/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'PARTYTYPE' and starts-with(text(), 'EXPORT')]">
												<xsl:for-each
												select="n1:CreditNote/cac:BuyerCustomerParty/cac:Party">
												<xsl:call-template name="Party_Title">
												<xsl:with-param name="PartyType"
									...
									<table border="1" id="despatchTable">
										<tbody>
											<tr>
												...
												<xsl:for-each
												select="n1:CreditNote/cbc:CustomizationID">
												<xsl:apply-templates/>
												</xsl:for-each>
												</td>
											</tr>
					...
					<table border="1" id="lineTable" width="800">
						<tbody>
							...
							<xsl:if test="count(//n1:CreditNote/cac:CreditNoteLine) &lt; 20">
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[11]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[11]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[12]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[12]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[13]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[13]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[14]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[14]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[15]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[15]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[16]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[16]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[17]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[17]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[18]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[18]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[19]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[19]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:CreditNote/cac:CreditNoteLine[20]">
										<xsl:apply-templates
											select="//n1:CreditNote/cac:CreditNoteLine[20]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:CreditNote"/>
									</xsl:otherwise>
